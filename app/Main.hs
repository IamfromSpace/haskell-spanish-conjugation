...
type VerbConfig = (Bool, Bool, Bool, Bool)
...
verbs =
    [ ((False, False, False, False), "aprender")
    , ((False, False, False, False), "argüir")
    , ((False, False, False, False), "averiguar")
    , ((False, False, False, False), "beber")
    , ((False, False, False, False), "caminar")
    , ((False, False, False, False), "comer")
    , ((False, False, False, False), "construir")
    , ((False, False, False, False), "decidir")
    , ((False, False, False, False), "delinquir")
    , ((False, False, False, False), "distinguir")
    , ((False, False, False, False), "gozar")
    , ((False, False, False, False), "hablar")
    , ((False, False, False, False), "insistir")
    , ((False, False, False, False), "leer")
    -- TODO: (#10) Leading 'll' does not parse.
    --, ((False, False), "llevar")
    , ((False, False, False, False), "proteger")
    , ((False, False, False, False), "tocar")
    , ((False, False, False, False), "vencer")
    , ((False, False, False, False), "vivir")
    , ((False, False, False, True), "elegir")
    , ((False, False, False, True), "pedir")
    , ((False, False, False, True), "teñir")
    , ((False, False, True, False), "avergonzar")
    , ((False, False, True, False), "contar")
    , ((False, False, True, False), "errar")
    , ((False, False, True, False), "jugar")
    , ((False, False, True, False), "oler")
    , ((False, False, True, False), "pensar")
    , ((False, False, True, True), "dormir")
    , ((False, False, True, True), "sentir")
    , ((False, True, False, False), "enviar")
    , ((False, True, False, False), "aunar")
    , ((True, False, False, False), "conocer")
    , ((True, False, False, False), "nacer")
    ]
