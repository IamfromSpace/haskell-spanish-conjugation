...
type VerbConfig = (Bool, Bool, Bool, Bool, Bool)
...
verbs =
    [ ((False, False, False, False, False), "aprender")
    , ((False, False, False, False, False), "argüir")
    , ((False, False, False, False, False), "averiguar")
    , ((False, False, False, False, False), "beber")
    , ((False, False, False, False, False), "caminar")
    , ((False, False, False, False, False), "comer")
    , ((False, False, False, False, False), "construir")
    , ((False, False, False, False, False), "decidir")
    , ((False, False, False, False, False), "delinquir")
    , ((False, False, False, False, False), "distinguir")
    , ((False, False, False, False, False), "gozar")
    , ((False, False, False, False, False), "hablar")
    , ((False, False, False, False, False), "insistir")
    , ((False, False, False, False, False), "leer")
    -- TODO: (#10) Leading 'll' does not parse.
    --, ((False, False), "llevar")
    , ((False, False, False, False, False), "proteger")
    , ((False, False, False, False, False), "tocar")
    , ((False, False, False, False, False), "vencer")
    , ((False, False, False, False, False), "vivir")
    , ((False, False, False, False, True), "elegir")
    , ((False, False, False, False, True), "pedir")
    , ((False, False, False, False, True), "teñir")
    , ((False, False, False, True, False), "avergonzar")
    , ((False, False, False, True, False), "contar")
    , ((False, False, False, True, False), "errar")
    , ((False, False, False, True, False), "jugar")
    , ((False, False, False, True, False), "oler")
    , ((False, False, False, True, False), "pensar")
    , ((False, False, False, True, True), "dormir")
    , ((False, False, False, True, True), "sentir")
    , ((False, False, True, False, False), "enviar")
    , ((False, False, True, False, False), "aunar")
    , ((False, True, False, False, False), "conocer")
    , ((False, True, False, False, False), "nacer")
    , ((True, False, False, False, False), "asir")
    , ((True, False, False, False, False), "caer")
    ]
